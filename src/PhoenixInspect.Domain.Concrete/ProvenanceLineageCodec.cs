...
internal static class ProvenanceLineageCodec
{
    ...
    private static ReadOnlySpan<byte> NodeDomain => "PhoenixInspect.ProvenanceLineage.Node"u8;
    private static ReadOnlySpan<byte> GraphDomain => "PhoenixInspect.ProvenanceLineage.Graph"u8;
