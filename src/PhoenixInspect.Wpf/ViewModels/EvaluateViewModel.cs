...
/// <summary>One ready-made expression shape offered by the evaluation panel.</summary>
...
public sealed class EvaluateViewModel : ObservableObject
{
    ...
    /// <summary>Creates the evaluation panel.</summary>
    ...
    public EvaluateViewModel(IShellServices shell)
    {
        ...
        GroupedReportFacts = PropertyGrouping.Create(ReportFacts);
        RefreshSamples();
    }
    ...
    public ICollectionView GroupedReportFacts { get; }
    ...
    public string LimitsCaption =>
        ...
        + $"{CounterfactualMethodRequest.MaximumTraversalUnits} units by the product, independently of this panel.";
