...
/// </remarks>
public readonly record struct ClrmdSnapshotIdentity
{
    ...
    /// <summary>Gets the lowercase SHA-256 digest of the complete dump file.</summary>
    public string Sha256 { get; }

    /// <summary>Gets the provenance identifier used by raw memory-read evidence.</summary>
    public string MemorySourceId => $"dump-sha256:{Sha256}";
}
