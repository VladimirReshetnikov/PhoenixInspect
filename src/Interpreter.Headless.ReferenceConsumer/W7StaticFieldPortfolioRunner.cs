...
internal static class W7StaticFieldPortfolioRunner
{
    ...
    private static DumpSelectedFrameSelector FindFrame(ClrmdDumpSession session, string shape)
    {
        ...
        {
            "Request" => "Interpreter.W7TestTarget.Request",
            "Batch" => "Interpreter.W7TestTarget.BatchContext",
            "Coordinator" => "Interpreter.W7TestTarget.CoordinatorContext",
            "Workflow" => "Interpreter.W7TestTarget.Workflow",
