...
/// <summary>Classifies one exact constructed-runtime selection answer.</summary>
/// <remarks>
/// Only <see cref="Exact"/> exposes one selected construction. Every other alternative is a prefix-free stop:
...
public enum StaticFieldV2RuntimeConstructionSelectionKind
{
    ...
    /// <summary>A declared bound stopped the bounded candidate set before any grouping.</summary>
    NonExact = 4,
...
/// <summary>Identifies the deterministic issue of one constructed-runtime selection.</summary>
/// <remarks>This issue catalog keeps absence, ambiguity, the declared bound, and no-call answers distinct.</remarks>
public enum StaticFieldV2RuntimeConstructionIssue
{
    /// <summary>No issue applies to an exact selection.</summary>
    None = 0,
...
/// <summary>Classifies one static-slot acquisition answer.</summary>
/// <remarks>Only <see cref="Exact"/> exposes a slot; every other alternative is a prefix-free stop.</remarks>
...
/// <summary>Identifies the deterministic issue of one static-slot acquisition.</summary>
/// <remarks>
/// The catalog names each frozen per-strategy requirement and each frozen per-strategy rejection separately so a
...
/// <summary>Classifies one exact static-field runtime value decoded from copied raw bytes.</summary>
/// <remarks>The kind names the decoded shape; the payload primitive of an enum or nullable is retained apart.</remarks>
...
/// <summary>Classifies one static-field runtime value decoding answer.</summary>
/// <remarks>Only <see cref="Exact"/> exposes a decoded value; every alternative is a prefix-free stop.</remarks>
public enum StaticFieldV2RuntimeValueResultKind
{
    ...
    /// <summary>The declared closed type selects a shape this decoder does not admit.</summary>
    Unsupported = 3,
}

/// <summary>Identifies the deterministic issue of one static-field runtime value decoding.</summary>
/// <remarks>This catalog separates width disagreement, malformed encodings, and non-admitted shapes.</remarks>
public enum StaticFieldV2RuntimeValueIssue
{
    /// <summary>No issue applies to an exact decoding.</summary>
    None = 0,
    ...
    /// <summary>The declared closed type is not one of the admitted value shapes.</summary>
...
/// <summary>Identifies one declared coverage boundary retained by a constructed-runtime answer.</summary>
/// <remarks>
/// Each boundary is an informational fact naming physical evidence this slice accepts from the caller instead of
...
/// <summary>Freezes one exact selected-thread identity required by thread-relative storage.</summary>
/// <remarks>
/// W8.1 froze <c>ThreadRelativeSlot</c> as requiring an exact selected thread in addition to an exact owner
/// construction. This sealed identity carries only counted physical thread coordinates; no display name, no
...
public sealed class StaticFieldV2SelectedThreadIdentity : IEquatable<StaticFieldV2SelectedThreadIdentity>
{
    ...
    /// <summary>Gets the exact target pointer width in bytes of the thread's snapshot.</summary>
    public int PointerWidth { get; }

    /// <summary>Gets the nonzero target address of the selected thread's runtime structure.</summary>
    public ulong ThreadObjectAddress { get; }

    /// <summary>Gets the positive operating-system thread identifier of the selected thread.</summary>
    public int OperatingSystemThreadId { get; }

    /// <summary>Gets the positive managed thread identifier of the selected thread.</summary>
    public int ManagedThreadId { get; }

    /// <summary>Gets a defensive copy of the fixed-reference canonical thread bytes.</summary>
    public ImmutableArray<byte> CanonicalBytes => ExpressionV2ContractEncoding.Copy(canonicalBytes);

    /// <summary>Gets the lowercase SHA-256 digest of the canonical thread identity.</summary>
    public string Sha256 { get; }

    /// <summary>Creates one exact selected-thread identity from counted physical coordinates.</summary>
    ...
    /// <returns>A sealed immutable thread identity.</returns>
    ...
    /// <summary>Tests canonical equality between two selected-thread identities.</summary>
    /// <param name="other">The other thread identity.</param>
    ...
    /// <summary>Tests selected-thread identity equality against an arbitrary object.</summary>
    ...
    /// <summary>Computes a deterministic hash code from immutable canonical thread content.</summary>
    /// <returns>A hash code for this canonical thread identity.</returns>
    public override int GetHashCode() => CanonicalReplayEncoding.CanonicalHashCode(canonicalBytes);
}

/// <summary>Freezes one exact physical nullable storage layout supplied as a fact.</summary>
/// <remarks>
/// The admitted nullable forms are decoded from the exact hasValue flag byte plus the payload at the exact
...
{
    /// <summary>Gets the maximum admitted nullable storage byte count of one layout fact.</summary>
    ...
    /// <summary>Gets the complete specialized nullable storage size in bytes.</summary>
    public int StorageByteCount { get; }

    /// <summary>Gets the exact byte offset of the one-byte hasValue flag.</summary>
    public int HasValueOffset { get; }

    /// <summary>Gets the exact byte offset of the nullable payload.</summary>
    public int ValueOffset { get; }

    /// <summary>Gets the exact byte count of the nullable payload.</summary>
    public int ValueByteCount { get; }

    /// <summary>Gets a defensive copy of the fixed-reference canonical layout bytes.</summary>
    public ImmutableArray<byte> CanonicalBytes => ExpressionV2ContractEncoding.Copy(canonicalBytes);

    /// <summary>Gets the lowercase SHA-256 digest of the canonical layout fact.</summary>
    public string Sha256 { get; }

    /// <summary>Creates one exact nullable physical layout fact.</summary>
    ...
    /// <returns>A sealed immutable layout fact whose two child ranges are disjoint and in range.</returns>
    ...
    /// <summary>Tests canonical equality between two nullable layout facts.</summary>
    /// <param name="other">The other layout fact.</param>
    /// <returns><see langword="true"/> only for byte-identical canonical content.</returns>
    public bool Equals(StaticFieldV2NullableLayoutFact? other) =>
        other is not null && CanonicalReplayEncoding.CanonicalEquals(canonicalBytes, other.canonicalBytes);

    /// <summary>Tests nullable layout fact equality against an arbitrary object.</summary>
    /// <param name="obj">The object to compare.</param>
    ...
    /// <summary>Computes a deterministic hash code from immutable canonical layout content.</summary>
    /// <returns>A hash code for this canonical layout fact.</returns>
    public override int GetHashCode() => CanonicalReplayEncoding.CanonicalHashCode(canonicalBytes);
}

/// <summary>Freezes one caller-supplied complete constructed-runtime candidate identity.</summary>
/// <remarks>
/// The complete identity W8.1 froze is exactly this row: definition module and TypeDef token, loader module,
...
{
    /// <summary>Gets the maximum admitted ordered closed argument count of one candidate.</summary>
    ...
    /// <summary>Gets the nonzero runtime type handle address of this candidate.</summary>
    public ulong RuntimeTypeHandleAddress { get; }

    /// <summary>Gets the nonzero method-table address of this candidate.</summary>
    public ulong MethodTableAddress { get; }

    /// <summary>Gets the exact module that physically declared this candidate's TypeDef.</summary>
    public StaticFieldMetadataModuleIdentity DefinitionModule { get; }

    /// <summary>Gets the exact TypeDef token this candidate constructs.</summary>
    public int TypeDefinitionToken { get; }

    /// <summary>Gets the exact loader module that owns this candidate's construction.</summary>
    public StaticFieldMetadataModuleIdentity LoaderModule { get; }

    /// <summary>Gets the exact containing assembly of this candidate's construction.</summary>
    public StaticFieldContainingAssemblyIdentity Assembly { get; }

    /// <summary>Gets this candidate's loader-allocator address, or zero for a non-collectible construction.</summary>
    public ulong LoaderAllocatorAddress { get; }

    /// <summary>Gets this candidate's load-context address, or zero for the default load context.</summary>
    public ulong LoadContextAddress { get; }

    /// <summary>Gets the exact enclosing construction, or null for a top-level construction.</summary>
    public StaticFieldV2RuntimeConstructionCandidate? EnclosingConstruction { get; }

    /// <summary>Gets a defensive copy of the ordered recursive closed arguments of this candidate.</summary>
    public ImmutableArray<MetadataClosedTypeIdentity> ClosedArguments =>
        ExpressionV2ContractEncoding.Copy(closedArguments);

    /// <summary>Gets the ordered closed argument count of this candidate.</summary>
    public int ClosedArgumentCount => closedArguments.Length;

    /// <summary>Gets the exact target pointer width in bytes of this candidate's snapshot.</summary>
    public int PointerWidth => DefinitionModule.Module.PointerWidth;

    /// <summary>Gets a defensive copy of the bounded fixed-reference canonical candidate bytes.</summary>
    public ImmutableArray<byte> CanonicalBytes => ExpressionV2ContractEncoding.Copy(canonicalBytes);

    /// <summary>Gets the lowercase SHA-256 digest that is this candidate's complete construction identity.</summary>
    public string Sha256 { get; }

    /// <summary>Creates one caller-supplied complete constructed-runtime candidate.</summary>
    ...
    /// physical fact rather than missing evidence: the pinned runtime reports zero for every non-collectible
    /// construction, so requiring a nonzero value would make the ordinary case unrepresentable.
    /// </param>
    /// <param name="loadContextAddress">
    /// The exact assembly-load-context address, or zero for the default load context. Zero is a physical fact
    ...
    /// <returns>A sealed immutable candidate with a defensively copied argument vector.</returns>
    ...
    /// <summary>Tests canonical equality between two constructed-runtime candidates.</summary>
    /// <param name="other">The other candidate.</param>
    /// <returns><see langword="true"/> only for byte-identical canonical content.</returns>
    public bool Equals(StaticFieldV2RuntimeConstructionCandidate? other) =>
        other is not null && CanonicalReplayEncoding.CanonicalEquals(canonicalBytes, other.canonicalBytes);

    /// <summary>Tests constructed-runtime candidate equality against an arbitrary object.</summary>
    /// <param name="obj">The object to compare.</param>
...
/// <summary>Freezes one complete constructed-runtime selection request.</summary>
/// <remarks>
...
/// the identical selection, so the array is evidence and never a preference.
/// </remarks>
public sealed class StaticFieldV2RuntimeConstructionRequest : IEquatable<StaticFieldV2RuntimeConstructionRequest>
{
    ...
    /// <summary>Gets the exact bound metadata construction this selection must match.</summary>
    ...
    /// <summary>Gets a defensive copy of the complete bounded candidate set as supplied.</summary>
    public ImmutableArray<StaticFieldV2RuntimeConstructionCandidate> Candidates =>
        ExpressionV2ContractEncoding.Copy(candidates);

    /// <summary>Gets the supplied candidate count before any grouping.</summary>
    public int SuppliedCandidateCount => candidates.Length;

    /// <summary>Gets the caller-owned capability probes this selection routes every acquisition through.</summary>
    ...
    /// <summary>Creates one complete constructed-runtime selection request.</summary>
    ...
    /// <returns>A sealed immutable request with a defensively copied candidate set.</returns>
    /// <exception cref="ArgumentNullException">A required reference argument is null.</exception>
    ...
    /// <summary>Tests canonical equality between two constructed-runtime selection requests.</summary>
    /// <param name="other">The other request.</param>
    /// <returns><see langword="true"/> only for byte-identical canonical content.</returns>
    public bool Equals(StaticFieldV2RuntimeConstructionRequest? other) =>
        other is not null && CanonicalReplayEncoding.CanonicalEquals(canonicalBytes, other.canonicalBytes);

    /// <summary>Tests constructed-runtime selection request equality against an arbitrary object.</summary>
    /// <param name="obj">The object to compare.</param>
...
/// <summary>Freezes the complete outcome of one constructed-runtime selection.</summary>
/// <remarks>
/// The selection groups every supplied candidate by its complete construction identity, keeps only the groups
...
{
    /// <summary>Gets the frozen diagnostic code retained by an absent-construction stop.</summary>
    public const string ConstructionAbsentCode = "W8_RUNTIME_CONSTRUCTION_ABSENT";

    /// <summary>Gets the frozen diagnostic code retained by an ambiguous-construction stop.</summary>
    public const string ConstructionAmbiguousCode = "W8_RUNTIME_CONSTRUCTION_AMBIGUOUS";

    /// <summary>Gets the frozen diagnostic code retained by a not-required construction answer.</summary>
    ...
    /// <summary>Gets the shared runtime-construction cap applied by one complete selection.</summary>
    ...
    /// <summary>Gets whether this selection is exact, absent, ambiguous, bounded, or not required.</summary>
    public StaticFieldV2RuntimeConstructionSelectionKind ResultKind { get; }

    /// <summary>Gets the typed selection issue, or none for an exact outcome.</summary>
    ...
    /// <summary>Gets the single selected construction, or null for every prefix-free stop.</summary>
    public StaticFieldV2RuntimeConstructionCandidate? SelectedCandidate { get; }

    /// <summary>Gets the capability-call ledger proving which acquisitions this selection performed.</summary>
    ...
    /// <summary>Gets the distinct complete construction identity count of the grouped candidate set.</summary>
    public int DistinctConstructionCount { get; }

    /// <summary>Gets the count of distinct groups that matched the bound metadata construction.</summary>
    public int MatchingConstructionCount { get; }

    /// <summary>Gets the grouped, matching, or cap-plus-one observation of this answer.</summary>
    public int ObservedCount { get; }

    /// <summary>Gets the frozen diagnostic code of a typed stop, otherwise null.</summary>
    public string? DiagnosticCode { get; }

    /// <summary>Gets the classified storage strategy this selection obeyed.</summary>
    public StaticFieldV2StorageStrategy Strategy => Request.StorageStrategy.Strategy!.Value;

    /// <summary>Gets a defensive copy of the bounded fixed-reference canonical selection bytes.</summary>
    public ImmutableArray<byte> CanonicalBytes => ExpressionV2ContractEncoding.Copy(canonicalBytes);

    /// <summary>Gets the lowercase SHA-256 digest of the canonical selection.</summary>
    public string Sha256 { get; }

    /// <summary>Tests canonical equality between two constructed-runtime selections.</summary>
    /// <param name="other">The other selection.</param>
    /// <returns><see langword="true"/> only for byte-identical canonical content.</returns>
    public bool Equals(StaticFieldV2RuntimeConstructionSelection? other) =>
        other is not null && CanonicalReplayEncoding.CanonicalEquals(canonicalBytes, other.canonicalBytes);

    /// <summary>Tests constructed-runtime selection equality against an arbitrary object.</summary>
    /// <param name="obj">The object to compare.</param>
    ...
    /// <summary>Computes a deterministic hash code from immutable canonical selection content.</summary>
    /// <returns>A hash code for this canonical selection.</returns>
    public override int GetHashCode() => CanonicalReplayEncoding.CanonicalHashCode(canonicalBytes);
...
/// <summary>Freezes one exact static-slot identity for one classified storage strategy.</summary>
/// <remarks>
/// The sealed identity is minted only by <see cref="StaticFieldV2StaticSlotOutcome"/>. A constructed slot and a
...
public sealed class StaticFieldV2StaticSlotIdentity : IEquatable<StaticFieldV2StaticSlotIdentity>
{
    ...
    /// <summary>Gets the classified storage strategy that owns this slot.</summary>
    ...
    /// <summary>Gets the exact physical FieldDef token whose storage this slot names.</summary>
    ...
    /// <summary>Gets the exact counted read width in bytes of this slot.</summary>
    public int ReadWidth { get; }

    /// <summary>Gets the exact selected thread, or null for every non thread-relative strategy.</summary>
    public StaticFieldV2SelectedThreadIdentity? SelectedThread { get; }

    /// <summary>Gets the exact module content identity, or null for every non module-RVA strategy.</summary>
    public ModuleContentIdentity? ModuleContent { get; }

    /// <summary>Gets the exact FieldRVA row token, or null for every non module-RVA strategy.</summary>
    public int? FieldRvaRowToken { get; }

    /// <summary>Gets the exact mapped relative virtual address, or null for every non module-RVA strategy.</summary>
    public uint? MappedRelativeVirtualAddress { get; }

    /// <summary>Gets the exact mapped image address, or null for every non module-RVA strategy.</summary>
    public ulong? MappedAddress { get; }

    /// <summary>Gets the exact address the counted raw read must use for this slot.</summary>
    public ulong EffectiveAddress => SlotAddress ?? MappedAddress!.Value;

    /// <summary>Gets a defensive copy of the fixed-reference canonical slot bytes.</summary>
    public ImmutableArray<byte> CanonicalBytes => ExpressionV2ContractEncoding.Copy(canonicalBytes);

    /// <summary>Gets the lowercase SHA-256 digest of the canonical slot identity.</summary>
    public string Sha256 { get; }

    /// <summary>Tests canonical equality between two static-slot identities.</summary>
    /// <param name="other">The other slot identity.</param>
    /// <returns><see langword="true"/> only for byte-identical canonical content.</returns>
    public bool Equals(StaticFieldV2StaticSlotIdentity? other) =>
        other is not null && CanonicalReplayEncoding.CanonicalEquals(canonicalBytes, other.canonicalBytes);

    /// <summary>Tests static-slot identity equality against an arbitrary object.</summary>
    /// <param name="obj">The object to compare.</param>
    /// <returns><see langword="true"/> only for a slot with identical canonical content.</returns>
    public override bool Equals(object? obj) => Equals(obj as StaticFieldV2StaticSlotIdentity);

    /// <summary>Computes a deterministic hash code from immutable canonical slot content.</summary>
    /// <returns>A hash code for this canonical slot identity.</returns>
    public override int GetHashCode() => CanonicalReplayEncoding.CanonicalHashCode(canonicalBytes);
...
/// <summary>Freezes one complete static-slot acquisition request.</summary>
/// <remarks>
...
{
    /// <summary>Gets the maximum admitted counted read width in bytes of one slot request.</summary>
    ...
    /// <summary>Gets the supplied owner construction selection, or null when none was supplied.</summary>
    ...
    /// <summary>Gets the exact physical FieldDef token this acquisition names.</summary>
...
/// <summary>Freezes the complete outcome of one static-slot acquisition.</summary>
/// <remarks>
/// This sealed outcome is the sole issuer of the static-slot identity it retains. An exact answer names one slot
...
{
    /// <summary>Gets the frozen diagnostic code retained by a metadata-literal slot non-admission.</summary>
    public const string MetadataLiteralHasNoSlotCode = "W8_METADATA_LITERAL_HAS_NO_SLOT";

    /// <summary>Gets the frozen diagnostic code retained by a contradicted slot-geometry stop.</summary>
    ...
    /// <summary>Gets whether this acquisition is exact, invalid, or a typed non-admission.</summary>
    public StaticFieldV2StaticSlotResultKind ResultKind { get; }

    /// <summary>Gets the typed acquisition issue, or none for an exact outcome.</summary>
    public StaticFieldV2StaticSlotIssue Issue { get; }

    /// <summary>Gets the complete request that produced this outcome.</summary>
    public StaticFieldV2StaticSlotRequest Request { get; }

    /// <summary>Gets the single acquired slot, or null for every prefix-free stop.</summary>
    ...
    /// <summary>Gets the classified storage strategy this acquisition validated.</summary>
    public StaticFieldV2StorageStrategy Strategy => Request.StorageStrategy.Strategy!.Value;
    ...
    /// <summary>Tests canonical equality between two static-slot outcomes.</summary>
    /// <param name="other">The other outcome.</param>
    /// <returns><see langword="true"/> only for byte-identical canonical content.</returns>
    public bool Equals(StaticFieldV2StaticSlotOutcome? other) =>
        other is not null && CanonicalReplayEncoding.CanonicalEquals(canonicalBytes, other.canonicalBytes);

    /// <summary>Tests static-slot outcome equality against an arbitrary object.</summary>
    /// <param name="obj">The object to compare.</param>
...
/// <summary>Freezes one complete static-field runtime value decoding request.</summary>
/// <remarks>
...
{
    /// <summary>Gets the maximum admitted copied raw byte count of one value request.</summary>
    ...
    /// <summary>Gets the copied raw byte count supplied for decoding.</summary>
    ...
    /// <summary>Gets the caller-owned capability probes this pure decoding never invokes.</summary>
    public ExpressionV2CapabilityProbeSet? CapabilityProbes { get; }
    ...
    /// <summary>Creates one complete static-field runtime value decoding request.</summary>
    ...
    /// <returns>A sealed immutable request with a defensively copied byte payload.</returns>
    ...
    /// <summary>Tests canonical equality between two runtime value decoding requests.</summary>
    /// <param name="other">The other request.</param>
    /// <returns><see langword="true"/> only for byte-identical canonical content.</returns>
    public bool Equals(StaticFieldV2RuntimeValueRequest? other) =>
        other is not null && CanonicalReplayEncoding.CanonicalEquals(canonicalBytes, other.canonicalBytes);

    /// <summary>Tests runtime value decoding request equality against an arbitrary object.</summary>
    /// <param name="obj">The object to compare.</param>
    /// <returns><see langword="true"/> only for a request with identical canonical content.</returns>
...
/// <summary>Freezes the complete outcome of one static-field runtime value decoding.</summary>
/// <remarks>
/// This sealed outcome is the sole issuer of the capability-call ledger it retains. Decoding is pure over the
...
public sealed class StaticFieldV2RuntimeValueOutcome : IEquatable<StaticFieldV2RuntimeValueOutcome>
{
    ...
    /// <summary>Gets whether this decoding is exact, invalid, or a typed non-admission.</summary>
    public StaticFieldV2RuntimeValueResultKind ResultKind { get; }

    /// <summary>Gets the typed decoding issue, or none for an exact outcome.</summary>
    public StaticFieldV2RuntimeValueIssue Issue { get; }

    /// <summary>Gets the complete request that produced this outcome.</summary>
    public StaticFieldV2RuntimeValueRequest Request { get; }

    /// <summary>Gets the decoded value shape, or null for every prefix-free stop.</summary>
    public StaticFieldV2RuntimeValueKind? ValueKind { get; }

    /// <summary>Gets the underlying primitive of an enum or nullable payload, otherwise null.</summary>
    public MetadataPrimitiveTypeKind? PayloadKind { get; }

    /// <summary>Gets the decoded signed value for a signed integral shape, otherwise null.</summary>
    public long? SignedValue { get; }

    /// <summary>Gets the decoded unsigned value for an unsigned, char, or boolean shape, otherwise null.</summary>
    public ulong? UnsignedValue { get; }

    /// <summary>Gets the exact floating bit pattern for a single or double shape, otherwise null.</summary>
    public ulong? FloatingBitPattern { get; }

    /// <summary>Gets the retained non-null target address of a managed reference, otherwise null.</summary>
    ...
    /// <summary>Gets whether this exact answer decoded a present nullable payload.</summary>
    public bool HasNullableValue => ValueKind == StaticFieldV2RuntimeValueKind.NullablePresent;

    /// <summary>Gets the capability-call ledger proving this decoding performed no capability call.</summary>
    public StaticFieldV2CapabilityCallLedger CapabilityCallLedger { get; }
    ...
    /// <summary>Gets the declared width in bytes the closed type required, or zero when none applies.</summary>
    public int DeclaredWidth { get; }

    /// <summary>Gets the supplied copied byte count observed by this decoding.</summary>
    public int ObservedCount { get; }
    ...
    /// <summary>Tests canonical equality between two runtime value outcomes.</summary>
    /// <param name="other">The other outcome.</param>
    /// <returns><see langword="true"/> only for byte-identical canonical content.</returns>
    public bool Equals(StaticFieldV2RuntimeValueOutcome? other) =>
        other is not null && CanonicalReplayEncoding.CanonicalEquals(canonicalBytes, other.canonicalBytes);

    /// <summary>Tests runtime value outcome equality against an arbitrary object.</summary>
    /// <param name="obj">The object to compare.</param>
    /// <returns><see langword="true"/> only for an outcome with identical canonical content.</returns>
...
/// <summary>Selects one exact runtime construction and its static slot from caller-supplied physical evidence.</summary>
/// <remarks>
/// This binder owns the two frozen W8.1 rules that map one bound metadata construction onto physical storage:
...
/// </para>
/// <para>
/// Declared coverage boundaries of this slice: this slice opens no dump, so every candidate, selected thread, and
...
{
    /// <summary>Selects the single exact runtime construction matching one bound metadata construction.</summary>
    /// <param name="request">The complete constructed-runtime selection request.</param>
    /// <remarks>
    /// Every supplied candidate is grouped by its complete construction identity. A group matches only when its
    ...
    /// canonical digest, so presenting the same candidates in any order yields the identical answer.
    /// </remarks>
    /// <returns>A sealed immutable selection that is either one construction or one prefix-free stop.</returns>
    ...
    /// <summary>Acquires the single exact static slot of one classified storage strategy.</summary>
    ...
    /// </remarks>
    /// <returns>A sealed immutable outcome that is either one slot or one prefix-free typed stop.</returns>
    /// <exception cref="ArgumentNullException"><paramref name="request"/> is null.</exception>
...
/// <summary>Decodes one exact static-field value from copied raw bytes and the field's closed type.</summary>
/// <remarks>
/// Every address-backed W8.1 value is decoded from copied raw bytes; a high-level runtime read is a late oracle only
/// and never appears here. This decoder therefore consults no capability at all, which the retained ledger
/// records, and it never assumes a pointer size: the target width is a supplied fact.
/// <para>
/// The admitted shapes are every CLI fixed-width integer with exact signedness and width, <c>bool</c>,
...
{
    /// <summary>Decodes one static-field value purely from the supplied copied bytes.</summary>
    /// <param name="request">The complete static-field runtime value decoding request.</param>
    /// <remarks>
    /// The declared width is derived from the closed type alone; a supplied byte count that disagrees with it is
