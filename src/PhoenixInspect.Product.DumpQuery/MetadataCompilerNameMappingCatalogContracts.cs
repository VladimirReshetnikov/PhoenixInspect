...
/// <summary>Classifies one complete authority-to-compiler-name draft catalog projection.</summary>
/// <remarks>
...
/// <summary>Identifies the typed prerequisite issue of one compiler-name mapping draft catalog.</summary>
/// <remarks>
...
/// <summary>Freezes the complete compiler-name mapping draft catalog for one definition authority.</summary>
/// <remarks>
/// This sealed draft catalog is the sole issuer of authority-bound compiler-name mapping identities. It selects every
    ...
    IEquatable<MetadataCompilerNameMappingCatalogIdentity>
{
    ...
    /// <summary>Gets whether this complete draft projection is exact, non-exact, or invalid.</summary>
    public MetadataCompilerNameMappingCatalogResultKind ResultKind { get; }

    /// <summary>Gets the typed catalog-level draft issue, or none for an exact complete projection.</summary>
    ...
    /// <summary>Gets the prerequisite operation bound for a non-exact draft outcome, otherwise null.</summary>
    public EvaluationDeterministicBound? ReachedBound => DefinitionAuthority.ReachedBound;

    /// <summary>Gets the prerequisite issue-related draft observation count.</summary>
    ...
    /// <summary>Creates one complete authority-to-compiler-name draft catalog projection.</summary>
    /// <param name="definitionAuthority">
    /// The complete physical definition-authority draft outcome whose exact TypeDef rows are the sole mapping inputs.
    /// </param>
    /// <returns>
    ...
    /// <summary>Tests canonical equality between two complete compiler-name mapping draft catalogs.</summary>
    ...
    /// <summary>Tests compiler-name mapping draft catalog equality against an arbitrary object.</summary>
    ...
    /// <summary>Computes a deterministic hash code from the immutable compiler-name mapping draft catalog.</summary>
