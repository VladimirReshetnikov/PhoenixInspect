...
public static partial class ConstantExpressionEvaluator
{
    ...
    /// </summary>
    private static ImmutableArray<ConstantValueChild> ChildrenOf(Operand operand)
    {
        switch (operand.Kind)
        {
            case OperandKind.Sequence:
                ...
                var rows = ImmutableArray.CreateBuilder<ConstantValueChild>(
                ...
                {
                    rows.Add(new ConstantValueChild(
                        "…",
            ...
            case OperandKind.Tuple:
                ...
                var tupleRows = ImmutableArray.CreateBuilder<ConstantValueChild>(tuplePayload.Items.Length);
    ...
    private static ConstantValueChild ChildOf(string name, Operand item) => new(
        name,
