...
/// <summary>
/// The active <c>using</c> directives of a evaluation session: imported namespaces, statically imported
...
public sealed class UsingDirectiveSet
{
    ...
    public static readonly UsingDirectiveSet Empty = new([], [], ImmutableDictionary<string, string>.Empty);
    ...
    public UsingDirectiveSet WithImportedNamespace(string namespaceName)
    {
        ArgumentException.ThrowIfNullOrWhiteSpace(namespaceName);
        return importedNamespaces.Contains(namespaceName, StringComparer.Ordinal)
            ? this
            : new UsingDirectiveSet(
    ...
    public UsingDirectiveSet WithStaticImport(string typeFullName)
    {
    ...
    public UsingDirectiveSet WithAlias(string alias, string target)
    {
        ArgumentException.ThrowIfNullOrWhiteSpace(alias);
        ArgumentException.ThrowIfNullOrWhiteSpace(target);
        return new UsingDirectiveSet(
            importedNamespaces,
            staticImportedTypes,
