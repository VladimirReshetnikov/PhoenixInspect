...
{
    private const string NondeterministicCode = "CONSTANT_NONDETERMINISTIC_UNSUPPORTED";
    ...
    /// <c>new DateOnly(...)</c>, and <c>new TimeOnly(...)</c> over folded constant arguments, with the exact
    /// BCL constructor semantics; every other object creation stays not-constant.
    /// </summary>
