...
/// <summary>Classifies one physical runtime acquisition answer.</summary>
/// <remarks>Only <see cref="Exact"/> exposes acquired physical facts; every alternative is a prefix-free stop.</remarks>
public enum StaticFieldV2RuntimeAcquisitionResultKind
{
    ...
    /// <summary>A required physical fact was absent, ambiguous, or reached a declared bound.</summary>
    NonExact = 2,

    /// <summary>Complete acquired evidence contradicted an already-declared invariant.</summary>
    Invalid = 3,

    /// <summary>The frozen capability vector or this slice's declared coverage owns no answer here.</summary>
    Unsupported = 4,
}

/// <summary>Names the exact acquisition step at which one runtime acquisition stopped.</summary>
/// <remarks>
/// The stage is one-to-one with the physical steps this adapter performs, so a consumer never has to infer the
/// stop site from a message. <see cref="None"/> applies only to an exact answer.
/// </remarks>
public enum StaticFieldV2RuntimeAcquisitionStage
{
    ...
    /// <summary>The landed candidate-keyed selection ran over the emitted candidate rows.</summary>
...
/// <summary>Identifies the deterministic issue of one runtime acquisition.</summary>
/// <remarks>
...
public enum StaticFieldV2RuntimeAcquisitionIssue
{
    ...
    /// <summary>A metadata literal lives entirely in metadata, so it owns no runtime storage at all.</summary>
    ...
    /// <summary>The same-definition candidate count reached the declared runtime-construction cap plus one.</summary>
    ...
    /// <summary>A frame-value root homed in a register is not admitted by this slice.</summary>
    FrameRegisterHomeNotAdmitted = 15,

    /// <summary>A selected frame's own generic arguments are not admitted by this slice.</summary>
    ...
    /// <summary>The selected frame-value root reports a payload width outside the admitted range.</summary>
...
/// <summary>Identifies one declared coverage boundary retained by a runtime acquisition answer.</summary>
/// <remarks>
/// Every boundary is an informational fact naming what this adapter deliberately does not model, so a consumer
...
/// <summary>Freezes the retained physical evidence of one opened runtime acquisition snapshot.</summary>
/// <remarks>
...
public sealed class StaticFieldV2RuntimeSnapshotEvidence : IEquatable<StaticFieldV2RuntimeSnapshotEvidence>
{
    ...
    /// <summary>Gets the deterministic snapshot digest derived from enumerated module geometry alone.</summary>
    public string SnapshotSha256 { get; }

    /// <summary>Gets the exact target pointer width in bytes of the pinned snapshot.</summary>
    ...
    /// <summary>Gets the exact contract-descriptor flag word of the pinned snapshot.</summary>
    ...
    /// <summary>Gets the exact enumerated runtime-module count of the pinned snapshot.</summary>
    public int EnumeratedModuleCount { get; }

    /// <summary>Gets a defensive copy of the fixed-reference canonical evidence bytes.</summary>
    public ImmutableArray<byte> CanonicalBytes => ExpressionV2ContractEncoding.Copy(canonicalBytes);

    /// <summary>Gets the lowercase SHA-256 digest of the canonical evidence.</summary>
    public string Sha256 { get; }

    /// <summary>Tests canonical equality between two runtime snapshot evidences.</summary>
    /// <param name="other">The other evidence.</param>
    /// <returns><see langword="true"/> only for byte-identical canonical content.</returns>
    public bool Equals(StaticFieldV2RuntimeSnapshotEvidence? other) =>
        other is not null && CanonicalReplayEncoding.CanonicalEquals(canonicalBytes, other.canonicalBytes);

    /// <summary>Tests runtime snapshot evidence equality against an arbitrary object.</summary>
    /// <param name="obj">The object to compare.</param>
    /// <returns><see langword="true"/> only for evidence with identical canonical content.</returns>
    public override bool Equals(object? obj) => Equals(obj as StaticFieldV2RuntimeSnapshotEvidence);

    /// <summary>Computes a deterministic hash code from immutable canonical evidence content.</summary>
    /// <returns>A hash code for this canonical evidence.</returns>
    public override int GetHashCode() => CanonicalReplayEncoding.CanonicalHashCode(canonicalBytes);
...
/// <summary>Reports one enumerated runtime module of the pinned snapshot.</summary>
/// <remarks>
...
public sealed class StaticFieldV2RuntimeModuleObservation
{
    ...
    /// <summary>Gets the nonzero runtime module structure address of this observation.</summary>
    public ulong ModuleAddress { get; }

    /// <summary>Gets the runtime assembly structure address containing this module.</summary>
    public ulong AssemblyAddress { get; }

    /// <summary>Gets the application-domain address that owns this module.</summary>
    public ulong ApplicationDomainAddress { get; }

    /// <summary>Gets the mapped image base of this module, or zero when it is not mapped.</summary>
    public ulong ImageBase { get; }

    /// <summary>Gets the mapped image size in bytes of this module.</summary>
    public ulong ImageSize { get; }

    /// <summary>Gets the address of this module's complete ECMA-335 metadata image.</summary>
    public ulong MetadataAddress { get; }

    /// <summary>Gets the byte count of this module's complete ECMA-335 metadata image.</summary>
    public ulong MetadataLength { get; }

    /// <summary>Gets this module's loader-allocator address, or zero when it is not collectible.</summary>
    public ulong LoaderAllocatorAddress { get; }
}

/// <summary>Freezes one caller-supplied binding of a runtime module to its exact metadata module identity.</summary>
/// <remarks>
...
public sealed class StaticFieldV2RuntimeModuleBinding : IEquatable<StaticFieldV2RuntimeModuleBinding>
{
    ...
    /// <summary>Gets the nonzero runtime module structure address this binding names.</summary>
    public ulong RuntimeModuleAddress { get; }

    /// <summary>Gets the mapped image base of the bound module, or zero when it is not mapped.</summary>
    public ulong ImageBase { get; }

    /// <summary>Gets the mapped image size in bytes of the bound module.</summary>
    public ulong ImageSize { get; }

    /// <summary>Gets the exact metadata module identity bound to that runtime module.</summary>
    public StaticFieldMetadataModuleIdentity MetadataModule { get; }

    /// <summary>Gets a defensive copy of the fixed-reference canonical binding bytes.</summary>
    public ImmutableArray<byte> CanonicalBytes => ExpressionV2ContractEncoding.Copy(canonicalBytes);

    /// <summary>Gets the lowercase SHA-256 digest of the canonical binding.</summary>
    public string Sha256 { get; }

    /// <summary>Creates one runtime-module to metadata-module binding.</summary>
    ...
    /// <returns>A sealed immutable binding.</returns>
    ...
    /// <summary>Tests canonical equality between two runtime-module bindings.</summary>
    /// <param name="other">The other binding.</param>
    /// <returns><see langword="true"/> only for byte-identical canonical content.</returns>
    public bool Equals(StaticFieldV2RuntimeModuleBinding? other) =>
        other is not null && CanonicalReplayEncoding.CanonicalEquals(canonicalBytes, other.canonicalBytes);

    /// <summary>Tests runtime-module binding equality against an arbitrary object.</summary>
    /// <param name="obj">The object to compare.</param>
    /// <returns><see langword="true"/> only for a binding with identical canonical content.</returns>
    public override bool Equals(object? obj) => Equals(obj as StaticFieldV2RuntimeModuleBinding);

    /// <summary>Computes a deterministic hash code from immutable canonical binding content.</summary>
    /// <returns>A hash code for this canonical binding.</returns>
    public override int GetHashCode() => CanonicalReplayEncoding.CanonicalHashCode(canonicalBytes);
}

/// <summary>Freezes one token-keyed predicate selecting exactly one thread of the pinned snapshot.</summary>
/// <remarks>
...
public sealed class StaticFieldV2RuntimeThreadSelector : IEquatable<StaticFieldV2RuntimeThreadSelector>
{
    ...
    /// <summary>Gets the nonzero runtime module address that must declare the selected frame's type.</summary>
    public ulong RuntimeModuleAddress { get; }

    /// <summary>Gets the exact TypeDef token that must declare the selected frame's method.</summary>
    public int TypeDefinitionToken { get; }

    /// <summary>Gets the exact MethodDef token the selected frame must execute.</summary>
    public int MethodDefinitionToken { get; }

    /// <summary>Gets a defensive copy of the fixed-reference canonical selector bytes.</summary>
    public ImmutableArray<byte> CanonicalBytes => ExpressionV2ContractEncoding.Copy(canonicalBytes);

    /// <summary>Gets the lowercase SHA-256 digest of the canonical selector.</summary>
    public string Sha256 { get; }

    /// <summary>Creates one token-keyed selected-thread predicate.</summary>
    ...
    /// <returns>A sealed immutable selector.</returns>
    ...
    /// <summary>Tests canonical equality between two selected-thread selectors.</summary>
    /// <param name="other">The other selector.</param>
    /// <returns><see langword="true"/> only for byte-identical canonical content.</returns>
    public bool Equals(StaticFieldV2RuntimeThreadSelector? other) =>
        other is not null && CanonicalReplayEncoding.CanonicalEquals(canonicalBytes, other.canonicalBytes);

    /// <summary>Tests selected-thread selector equality against an arbitrary object.</summary>
    /// <param name="obj">The object to compare.</param>
    /// <returns><see langword="true"/> only for a selector with identical canonical content.</returns>
    public override bool Equals(object? obj) => Equals(obj as StaticFieldV2RuntimeThreadSelector);

    /// <summary>Computes a deterministic hash code from immutable canonical selector content.</summary>
    /// <returns>A hash code for this canonical selector.</returns>
    public override int GetHashCode() => CanonicalReplayEncoding.CanonicalHashCode(canonicalBytes);
}

/// <summary>Freezes one complete constructed-runtime candidate acquisition request.</summary>
/// <remarks>
...
{
    /// <summary>Gets the maximum admitted caller-supplied runtime-module binding count.</summary>
    ...
    /// <summary>Gets the exact bound metadata construction the acquired candidates must match.</summary>
    public StaticFieldV2ClosedConstructionOutcome MetadataConstruction { get; }

    /// <summary>Gets the classified storage strategy whose frozen capability vector governs acquisition.</summary>
    public StaticFieldV2StorageStrategyOutcome StorageStrategy { get; }

    /// <summary>Gets the landed named-TypeDef chain portfolio used to project a named runtime argument.</summary>
    public MetadataNamedTypeDefinitionChainPortfolioIdentity ChainPortfolio { get; }

    /// <summary>Gets the landed ancestry authority portfolio supplying every semantic classification.</summary>
    public MetadataAncestryAuthorityPortfolioIdentity AncestryPortfolio { get; }

    /// <summary>Gets a defensive copy of every caller-supplied runtime-module binding.</summary>
    ...
    /// <summary>Creates one complete constructed-runtime candidate acquisition request.</summary>
    ...
    /// <summary>Tests candidate acquisition request equality against an arbitrary object.</summary>
    /// <param name="obj">The object to compare.</param>
...
/// <summary>Freezes the complete outcome of one constructed-runtime candidate acquisition.</summary>
/// <remarks>
/// An exact answer emits every complete same-definition candidate row, counts every unprojectable one, and
...
{
    /// <summary>Gets the frozen diagnostic code retained by a capability-not-required answer.</summary>
    public const string CapabilityNotRequiredCode = "W8_RUNTIME_ACQUISITION_CAPABILITY_NOT_REQUIRED";

    /// <summary>Gets the frozen diagnostic code retained by an absent runtime-module binding stop.</summary>
    public const string ModuleBindingAbsentCode = "W8_RUNTIME_ACQUISITION_MODULE_BINDING_ABSENT";

    /// <summary>Gets the frozen diagnostic code retained by an unreadable runtime-layout stop.</summary>
    public const string RuntimeLayoutUnavailableCode = "W8_RUNTIME_ACQUISITION_LAYOUT_UNAVAILABLE";

    /// <summary>Gets the frozen diagnostic code retained by a candidate cap-plus-one stop.</summary>
    ...
    /// <summary>Gets whether this acquisition is exact, non-exact, invalid, or a typed non-admission.</summary>
    public StaticFieldV2RuntimeAcquisitionResultKind ResultKind { get; }

    /// <summary>Gets the exact acquisition step that stopped, or none for an exact answer.</summary>
    public StaticFieldV2RuntimeAcquisitionStage Stage { get; }

    /// <summary>Gets the typed acquisition issue, or none for an exact answer.</summary>
    ...
    /// <summary>Gets the retained physical evidence of the pinned snapshot.</summary>
    public StaticFieldV2RuntimeSnapshotEvidence Evidence { get; }

    /// <summary>Gets a defensive digest-ordered copy of every complete emitted candidate row.</summary>
    public ImmutableArray<StaticFieldV2RuntimeConstructionCandidate> Candidates =>
        ExpressionV2ContractEncoding.Copy(candidates);

    /// <summary>Gets the landed candidate-keyed selection, or null when acquisition stopped first.</summary>
    public StaticFieldV2RuntimeConstructionSelection? Selection { get; }

    /// <summary>Gets the capability-call ledger proving which acquisitions this outcome performed.</summary>
    ...
    /// <summary>Gets the frozen diagnostic code of a typed stop, otherwise null.</summary>
    ...
    /// <summary>Tests canonical equality between two candidate acquisition outcomes.</summary>
    /// <param name="other">The other outcome.</param>
    /// <returns><see langword="true"/> only for byte-identical canonical content.</returns>
    public bool Equals(StaticFieldV2RuntimeConstructionAcquisitionOutcome? other) =>
        other is not null && CanonicalReplayEncoding.CanonicalEquals(canonicalBytes, other.canonicalBytes);

    /// <summary>Tests candidate acquisition outcome equality against an arbitrary object.</summary>
    /// <param name="obj">The object to compare.</param>
    /// <returns><see langword="true"/> only for an outcome with identical canonical content.</returns>
...
/// <summary>Freezes one complete static-slot acquisition request over the pinned snapshot.</summary>
/// <remarks>
    ...
    IEquatable<StaticFieldV2StaticSlotAcquisitionRequest>
{
    ...
    /// <summary>Gets the exact classified storage strategy whose slot is acquired.</summary>
    public StaticFieldV2StorageStrategyOutcome StorageStrategy { get; }

    /// <summary>Gets the exact counted read width in bytes the acquired slot must carry.</summary>
    ...
    /// <summary>Gets the token-keyed selected-thread predicate, or null for every non thread-relative strategy.</summary>
    public StaticFieldV2RuntimeThreadSelector? ThreadSelector { get; }

    /// <summary>Gets the declaring runtime-module binding, or null for every non module-RVA strategy.</summary>
    public StaticFieldV2RuntimeModuleBinding? DeclaringModuleBinding { get; }

    /// <summary>Gets the caller-owned capability probes this acquisition routes every call through.</summary>
    public ExpressionV2CapabilityProbeSet? CapabilityProbes { get; }

    /// <summary>Gets the exact physical FieldDef token whose storage this acquisition names.</summary>
    ...
    /// <summary>Creates one complete static-slot acquisition request.</summary>
    ...
    /// <summary>Tests canonical equality between two static-slot acquisition requests.</summary>
    /// <param name="other">The other request.</param>
    /// <returns><see langword="true"/> only for byte-identical canonical content.</returns>
    public bool Equals(StaticFieldV2StaticSlotAcquisitionRequest? other) =>
        other is not null && CanonicalReplayEncoding.CanonicalEquals(canonicalBytes, other.canonicalBytes);

    /// <summary>Tests static-slot acquisition request equality against an arbitrary object.</summary>
    /// <param name="obj">The object to compare.</param>
    /// <returns><see langword="true"/> only for a request with identical canonical content.</returns>
...
/// <summary>Freezes the complete outcome of one static-slot acquisition over the pinned snapshot.</summary>
/// <remarks>
...
{
    /// <summary>Gets the frozen diagnostic code retained by a metadata-literal non-admission.</summary>
    public const string MetadataLiteralHasNoRuntimeStorageCode = "W8_RUNTIME_ACQUISITION_LITERAL_HAS_NO_STORAGE";

    /// <summary>Gets the frozen diagnostic code retained by an unavailable slot-address stop.</summary>
    public const string SlotAddressUnavailableCode = "W8_RUNTIME_ACQUISITION_SLOT_ADDRESS_UNAVAILABLE";

    /// <summary>Gets the frozen diagnostic code retained by an absent selected-thread stop.</summary>
    public const string SelectedThreadAbsentCode = "W8_RUNTIME_ACQUISITION_THREAD_ABSENT";

    /// <summary>Gets the frozen diagnostic code retained by an ambiguous selected-thread stop.</summary>
    public const string SelectedThreadAmbiguousCode = "W8_RUNTIME_ACQUISITION_THREAD_AMBIGUOUS";

    /// <summary>Gets the frozen diagnostic code retained by a module-RVA geometry stop.</summary>
    ...
    /// <summary>Gets the landed static-slot outcome, or null when acquisition stopped first.</summary>
    public StaticFieldV2StaticSlotOutcome? SlotOutcome { get; }

    /// <summary>Gets the exact acquired selected-thread identity, otherwise null.</summary>
    ...
    /// <summary>Gets the thread count that satisfied the token-keyed selected-frame predicate.</summary>
    ...
    /// <summary>Tests canonical equality between two static-slot acquisition outcomes.</summary>
    /// <param name="other">The other outcome.</param>
    /// <returns><see langword="true"/> only for byte-identical canonical content.</returns>
    public bool Equals(StaticFieldV2StaticSlotAcquisitionOutcome? other) =>
        other is not null && CanonicalReplayEncoding.CanonicalEquals(canonicalBytes, other.canonicalBytes);

    /// <summary>Tests static-slot acquisition outcome equality against an arbitrary object.</summary>
    /// <param name="obj">The object to compare.</param>
    /// <returns><see langword="true"/> only for an outcome with identical canonical content.</returns>
...
/// <summary>Freezes one complete counted raw read and value decoding request.</summary>
/// <remarks>
    ...
    IEquatable<StaticFieldV2RuntimeValueAcquisitionRequest>
{
    ...
    /// <summary>Gets the exact classified storage strategy whose frozen capability vector governs the read.</summary>
    public StaticFieldV2StorageStrategyOutcome StorageStrategy { get; }

    /// <summary>Gets the exact acquired static-slot outcome naming the address and declared width.</summary>
    public StaticFieldV2StaticSlotOutcome Slot { get; }

    /// <summary>Gets the exact closed type of the static field whose value is decoded.</summary>
    public MetadataClosedTypeIdentity DeclaredType { get; }

    /// <summary>Gets the exact enum underlying primitive fact, or null when none was supplied.</summary>
    public MetadataPrimitiveTypeKind? EnumUnderlyingKind { get; }

    /// <summary>Gets the exact nullable physical layout fact, or null when none was supplied.</summary>
    ...
    /// <summary>Creates one complete counted raw read and value decoding request.</summary>
    /// <param name="storageStrategy">One exact classified storage strategy.</param>
    ...
    /// <summary>Tests canonical equality between two counted raw read requests.</summary>
    /// <param name="other">The other request.</param>
    /// <returns><see langword="true"/> only for byte-identical canonical content.</returns>
    public bool Equals(StaticFieldV2RuntimeValueAcquisitionRequest? other) =>
        other is not null && CanonicalReplayEncoding.CanonicalEquals(canonicalBytes, other.canonicalBytes);

    /// <summary>Tests counted raw read request equality against an arbitrary object.</summary>
    /// <param name="obj">The object to compare.</param>
    /// <returns><see langword="true"/> only for a request with identical canonical content.</returns>
...
/// <summary>Freezes the complete outcome of one counted raw read and value decoding.</summary>
/// <remarks>
    ...
    IEquatable<StaticFieldV2RuntimeValueAcquisitionOutcome>
{
    ...
    /// <summary>Gets the frozen diagnostic code retained by an incomplete counted raw read.</summary>
    ...
    /// <summary>Gets the lowercase SHA-256 digest of the copied raw bytes.</summary>
    public string RawBytesSha256 { get; }

    /// <summary>Gets the landed pure decoding over the copied bytes, or null when the read stopped.</summary>
    ...
    /// <summary>Gets the declared width in bytes the acquired slot required.</summary>
    public int DeclaredWidth { get; }

    /// <summary>Gets the byte count the pinned snapshot actually supplied for the counted read.</summary>
    ...
    /// <summary>Tests canonical equality between two counted raw read outcomes.</summary>
    /// <param name="other">The other outcome.</param>
    /// <returns><see langword="true"/> only for byte-identical canonical content.</returns>
    public bool Equals(StaticFieldV2RuntimeValueAcquisitionOutcome? other) =>
        other is not null && CanonicalReplayEncoding.CanonicalEquals(canonicalBytes, other.canonicalBytes);

    /// <summary>Tests counted raw read outcome equality against an arbitrary object.</summary>
    /// <param name="obj">The object to compare.</param>
    /// <returns><see langword="true"/> only for an outcome with identical canonical content.</returns>
...
/// <summary>Freezes one caller-supplied Portable-PDB local-scope row of the selected frame's method.</summary>
/// <remarks>
...
/// declaring scope covers. The physical Portable-PDB image is not modeled by this slice, so these rows are the
...
{
    /// <summary>Gets the maximum admitted declared local-name character count of one row.</summary>
    public const int MaximumNameLength = 256;

    /// <summary>Gets the maximum admitted zero-based local-signature slot index of one row.</summary>
    ...
    /// <summary>Gets the exact declared local name this row carries.</summary>
    public string Name { get; }

    /// <summary>Gets the zero-based local-signature slot index this row names.</summary>
    public int SlotIndex { get; }

    /// <summary>Gets the inclusive IL offset at which this row's declaring scope begins.</summary>
    public int ScopeStartOffset { get; }

    /// <summary>Gets the exclusive IL offset at which this row's declaring scope ends.</summary>
    ...
    /// <summary>Creates one caller-supplied Portable-PDB local-scope row.</summary>
    ...
    /// <returns>A sealed immutable row.</returns>
    ...
    /// <summary>Tests canonical equality between two Portable-PDB local-scope rows.</summary>
    /// <param name="other">The other row.</param>
    /// <returns><see langword="true"/> only for byte-identical canonical content.</returns>
    public bool Equals(StaticFieldV2FramePortablePdbLocalRow? other) =>
        other is not null && CanonicalReplayEncoding.CanonicalEquals(canonicalBytes, other.canonicalBytes);

    /// <summary>Tests Portable-PDB local-scope row equality against an arbitrary object.</summary>
    /// <param name="obj">The object to compare.</param>
...
/// <summary>Freezes one complete frame-value root acquisition request.</summary>
/// <remarks>
...
{
    /// <summary>Gets the maximum admitted zero-based managed frame ordinal.</summary>
    public const int MaximumFrameOrdinal = ExpressionV2ContractLimits.MaximumFrameCountPerThread - 1;

    /// <summary>Gets the maximum admitted caller-supplied Portable-PDB local-scope row count.</summary>
    ...
    /// <summary>Gets the token-keyed selected-thread predicate of this frame-root request.</summary>
    public StaticFieldV2RuntimeThreadSelector ThreadSelector { get; }

    /// <summary>Gets the zero-based managed frame ordinal within the selected thread.</summary>
    public int FrameOrdinal { get; }

    /// <summary>Gets the admitted frame-value root family this request names.</summary>
    public StaticFieldV2FrameValueRootKind RootKind { get; }

    /// <summary>Gets the zero-based declared parameter or local ordinal, or zero for the receiver.</summary>
    public int RootOrdinal { get; }

    /// <summary>Gets the declared local name for a local root, otherwise null.</summary>
    public string? LocalName { get; }

    /// <summary>Gets a defensive copy of every caller-supplied Portable-PDB local-scope row.</summary>
    ...
    /// <summary>Creates one complete frame-value root acquisition request.</summary>
    ...
    /// <param name="capabilityProbes">Caller-owned probes whose counters become the retained ledger.</param>
    /// <returns>A sealed immutable request with a defensively copied row set.</returns>
    ...
    /// <summary>Tests canonical equality between two frame-value root requests.</summary>
    /// <param name="other">The other request.</param>
    /// <returns><see langword="true"/> only for byte-identical canonical content.</returns>
    public bool Equals(StaticFieldV2FrameValueRootRequest? other) =>
        other is not null && CanonicalReplayEncoding.CanonicalEquals(canonicalBytes, other.canonicalBytes);

    /// <summary>Tests frame-value root request equality against an arbitrary object.</summary>
    /// <param name="obj">The object to compare.</param>
    /// <returns><see langword="true"/> only for a request with identical canonical content.</returns>
...
/// <summary>Freezes the complete outcome of one frame-value root acquisition.</summary>
/// <remarks>
...
{
    /// <summary>Gets the frozen diagnostic code retained by a register-home frame-root non-admission.</summary>
    ...
    /// <summary>Gets the frozen diagnostic code retained by an absent selected-thread frame-root stop.</summary>
    public const string SelectedThreadAbsentCode = "W8_FRAME_ROOT_THREAD_ABSENT";

    /// <summary>Gets the frozen diagnostic code retained by an ambiguous selected-thread frame-root stop.</summary>
    public const string SelectedThreadAmbiguousCode = "W8_FRAME_ROOT_THREAD_AMBIGUOUS";

    /// <summary>Gets the frozen diagnostic code retained by an absent selected-frame stop.</summary>
    public const string SelectedFrameAbsentCode = "W8_FRAME_ROOT_FRAME_ABSENT";

    /// <summary>Gets the frozen diagnostic code retained by an unavailable instruction-offset stop.</summary>
    public const string InstructionOffsetUnavailableCode = "W8_FRAME_ROOT_INSTRUCTION_OFFSET_UNAVAILABLE";

    /// <summary>Gets the frozen diagnostic code retained by an absent physical root-ordinal stop.</summary>
    public const string RootOrdinalAbsentCode = "W8_FRAME_ROOT_ORDINAL_ABSENT";

    /// <summary>Gets the frozen diagnostic code retained by an entirely undeclared local-name stop.</summary>
    public const string LocalNameAbsentCode = "W8_FRAME_ROOT_LOCAL_NAME_ABSENT";

    /// <summary>Gets the frozen diagnostic code retained by a lexically inactive local stop.</summary>
    public const string LocalLexicallyInactiveCode = "W8_FRAME_ROOT_LOCAL_LEXICALLY_INACTIVE";

    /// <summary>Gets the frozen diagnostic code retained by a duplicate live local-name stop.</summary>
    public const string LocalNameAmbiguousCode = "W8_FRAME_ROOT_LOCAL_NAME_AMBIGUOUS";

    /// <summary>Gets the frozen diagnostic code retained by a zero-location frame-root stop.</summary>
    public const string LocationAbsentCode = "W8_FRAME_ROOT_LOCATION_ABSENT";

    /// <summary>Gets the frozen diagnostic code retained by a split-location frame-root stop.</summary>
    public const string LocationSplitCode = "W8_FRAME_ROOT_LOCATION_SPLIT";

    /// <summary>Gets the frozen diagnostic code retained by an unadmitted-flag frame-root stop.</summary>
    public const string LocationUnknownCode = "W8_FRAME_ROOT_LOCATION_UNKNOWN";

    /// <summary>Gets the frozen diagnostic code retained by an inadmissible payload-width stop.</summary>
    public const string RootWidthNotAdmittedCode = "W8_FRAME_ROOT_WIDTH_NOT_ADMITTED";

    /// <summary>Gets the frozen diagnostic code retained by an unreachable legacy stack-walk stop.</summary>
    public const string InteropUnavailableCode = "W8_FRAME_ROOT_INTEROP_UNAVAILABLE";

    /// <summary>Gets the frozen diagnostic code retained by a short counted frame-root read.</summary>
    ...
    /// <summary>Gets the exact attributed memory-home address of the root, otherwise null.</summary>
    public ulong? RootAddress { get; }

    /// <summary>Gets the exact attributed root width in bytes, otherwise null.</summary>
    public int? RootWidth { get; }

    /// <summary>Gets whether the root is live at the selected instruction offset, otherwise null.</summary>
    public bool? IsLive { get; }

    /// <summary>Gets a defensive copy of the bytes copied from the attributed root, otherwise empty.</summary>
    ...
    /// <summary>Tests canonical equality between two frame-value root outcomes.</summary>
    /// <param name="other">The other outcome.</param>
    /// <returns><see langword="true"/> only for byte-identical canonical content.</returns>
    public bool Equals(StaticFieldV2FrameValueRootOutcome? other) =>
        other is not null && CanonicalReplayEncoding.CanonicalEquals(canonicalBytes, other.canonicalBytes);

    /// <summary>Tests frame-value root outcome equality against an arbitrary object.</summary>
    /// <param name="obj">The object to compare.</param>
    /// <returns><see langword="true"/> only for an outcome with identical canonical content.</returns>
...
/// <summary>Acquires exact physical runtime facts for one static-field expression from a pinned full dump.</summary>
/// <remarks>
/// This adapter is the physical counterpart of the landed W8.1 runtime contracts. It opens one dump, reads the
...
{
    /// <summary>Gets the maximum admitted enumerated runtime module count of one pinned snapshot.</summary>
    public const int MaximumRuntimeModuleCount = 1_024;

    /// <summary>Gets the maximum admitted available-type bucket count of one loader module table.</summary>
    public const int MaximumHashBucketCount = 65_536;

    /// <summary>Gets the maximum admitted available-type entry count of one loader module table.</summary>
    public const int MaximumHashEntryCount = 65_536;

    /// <summary>Gets the maximum admitted complete metadata image byte count of one module.</summary>
    ...
    /// <summary>Gets the maximum admitted enumerated runtime thread count of one pinned snapshot.</summary>
    public const int MaximumRuntimeThreadCount = ExpressionV2ContractLimits.MaximumFrameThreadCount;

    /// <summary>Gets the maximum admitted managed frame count examined per thread.</summary>
    ...
    /// <summary>Gets the retained physical evidence of the opened pinned snapshot.</summary>
    public StaticFieldV2RuntimeSnapshotEvidence Evidence { get; }

    /// <summary>Gets a defensive address-ordered copy of every enumerated runtime module observation.</summary>
    public ImmutableArray<StaticFieldV2RuntimeModuleObservation> Modules { get; }

    /// <summary>Gets the exact target pointer width in bytes of the opened pinned snapshot.</summary>
    public int PointerWidth => Evidence.PointerWidth;

    /// <summary>Opens one pinned full dump and reads the runtime's own contract descriptor layout.</summary>
    ...
    /// </remarks>
    /// <returns>An opened session whose evidence proves which runtime layout every later read used.</returns>
    ...
    /// <summary>Copies one runtime module's complete ECMA-335 metadata image out of the pinned snapshot.</summary>
    /// <param name="runtimeModuleAddress">The nonzero runtime module structure address.</param>
    /// <remarks>The copy lets a caller bind a runtime module to an on-disk artifact by exact content alone.</remarks>
    /// <returns>The counted complete metadata image bytes of that module.</returns>
    ...
    /// <summary>Creates one metadata module-instance identity anchored to this pinned snapshot.</summary>
    ...
    /// <summary>Acquires every complete same-definition candidate and runs the landed selection over them.</summary>
    /// <param name="request">The complete constructed-runtime candidate acquisition request.</param>
    /// <remarks>
    ...
    /// <param name="request">The complete static-slot acquisition request.</param>
    /// <remarks>
    ...
    /// </remarks>
    /// <returns>A sealed immutable outcome carrying the acquired facts and the landed slot answer.</returns>
    /// <exception cref="ArgumentNullException"><paramref name="request"/> is null.</exception>
    /// <exception cref="ObjectDisposedException">The session is already disposed.</exception>
    ...
    /// <param name="request">The complete counted raw read and value decoding request.</param>
    /// <remarks>
    ...
    /// </remarks>
    /// <returns>A sealed immutable outcome carrying the copied bytes, their digest, and the landed decoding.</returns>
    /// <exception cref="ArgumentNullException"><paramref name="request"/> is null.</exception>
    /// <exception cref="ObjectDisposedException">The session is already disposed.</exception>
    ...
    /// <param name="request">The complete frame-value root acquisition request.</param>
    /// <remarks>
    ...
    /// </remarks>
    /// <returns>A sealed immutable outcome carrying the exact home or one prefix-free typed stop.</returns>
    /// <exception cref="ArgumentNullException"><paramref name="request"/> is null.</exception>
    /// <exception cref="ObjectDisposedException">The session is already disposed.</exception>
...
internal enum StaticFieldV2FrameLocationDisposition
{
    ...
    /// <summary>The root is homed in a register, which this slice never reads.</summary>
    RegisterHome = 7,

    /// <summary>The root reports a payload width outside the admitted range.</summary>
    WidthNotAdmitted = 8,
}
...
/// <summary>Contains every reflection and raw vtable call the frame-value root acquisition performs.</summary>
/// <remarks>
...
{
    /// <summary>Gets the maximum admitted counted payload width in bytes of one frame-value root.</summary>
...
/// <summary>Freezes every diagnostic code this runtime acquisition can retain outside a typed outcome.</summary>
...
public static class StaticFieldV2RuntimeAcquisitionCodes
{
    ...
    /// <summary>Gets the frozen code for a snapshot exposing more modules than the declared cap admits.</summary>
    ...
    /// <summary>Gets the frozen code for an unreadable available-type table.</summary>
    ...
    /// <summary>Gets the frozen code for an absent runtime-module binding.</summary>
    public const string ModuleBindingAbsentCode = "W8_RUNTIME_ACQUISITION_MODULE_BINDING_ABSENT";
...
/// <summary>Reports one physical acquisition fault that prevents any typed outcome from being issued.</summary>
/// <remarks>
/// The exception is reserved for faults observed before a request exists, such as opening a snapshot whose runtime
/// contract descriptor is absent. Every fault observed while serving a request becomes a typed stop instead.
/// </remarks>
public sealed class StaticFieldV2RuntimeAcquisitionException : InvalidOperationException
{
    /// <summary>Initializes one physical acquisition fault.</summary>
    /// <param name="code">The frozen prefix-free diagnostic code of the fault.</param>
    /// <param name="message">The human-readable description of the fault.</param>
    public StaticFieldV2RuntimeAcquisitionException(string code, string message)
        : base(message) => Code = code;

    /// <summary>Initializes one physical acquisition fault wrapping an underlying fault.</summary>
    /// <param name="code">The frozen prefix-free diagnostic code of the fault.</param>
    /// <param name="message">The human-readable description of the fault.</param>
    ...
    /// <summary>Gets the frozen prefix-free diagnostic code of this fault.</summary>
