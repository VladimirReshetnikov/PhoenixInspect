...
public sealed class OverviewViewModel : ObservableObject
{
    ...
    [
        ...
        "Deterministic expressions evaluate without a runtime value read: integer arithmetic folds with checked C# "
        + "semantics, deterministic culture-independent string and char operations (ordinal search, substrings, "
        + "invariant case mapping, char classification) evaluate over exact operands, and fully qualified enum "
