...
public sealed class ViewLocator : IDataTemplate
{
    ...
    public Control? Build(object? data)
    {
        ...
        Control? view = data switch
        {
            ...
            ProcessesTool => new ProcessesPaneView(),
    ...
    public bool Match(object? data) => data is
        CallStackTool or ThreadsTool or LocalsTool or WatchTool or ImmediateTool or ModulesTool or ProcessesTool
        or HeapSearchTool or EvaluateTool or ResultTool or WelcomeDocument or SourceDocument;
}
