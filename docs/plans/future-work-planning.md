...
| Edit-and-Continue / Hot Reload dumps | The [Edit-and-Continue Support Plan](edit-and-continue-support-plan.md) governs this research-gated area. E1 physical truth, E2 typed refusal for the composed binding pipeline, and E3 artifact-seam delta acquisition are complete; E2 remains the minimum independently shippable increment. E4 generation-aware authority composition is future work and is not the active release milestone. Section 2 preserves the measured pre-E1 baseline rather than the current implementation state. |
