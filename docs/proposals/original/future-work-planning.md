...
> updated to `PhoenixInspect`. The scope it describes — the original milestone roadmap covering virtual stepping, async and dynamic lifting, semantic modeling, abstract analysis, static analysis, and sandboxed execution — is a tentative future direction, not an active
...
> source is authoritative. Current counterpart: [`../../plans/future-work-planning.md`](../../plans/future-work-planning.md).
