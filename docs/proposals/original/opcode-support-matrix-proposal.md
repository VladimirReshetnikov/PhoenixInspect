...
> updated to `PhoenixInspect`. The scope it describes — broad, tiered IL opcode coverage planned ahead of executable evidence — is a tentative future direction, not an active
...
> source is authoritative. Current counterpart: [`../architecture/opcode-support-matrix-proposal.md`](../architecture/opcode-support-matrix-proposal.md).
