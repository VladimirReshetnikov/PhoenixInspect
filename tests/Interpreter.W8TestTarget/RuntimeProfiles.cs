...
namespace Interpreter.W8AmbiguityEvidence
{
    ...
    public static class CrossAssemblyAmbiguityProfile
    {
        ...
        public static int Run(string profile)
        {
            var localCandidate = new global::Interpreter.W8TestTarget.SharedSpelling(0x1F017A01);
            var externalCandidate = new global::Interpreter.W8AliasTarget.SharedSpelling(0x1F027A02);
