...
/// </summary>
public sealed class ExpressionEvaluatorReferenceCastTests
{
    ...
    public void Known_enums_round_trip_through_object()
    {
        ...
        Assert.Equal(ExpressionEvaluationStatus.Exact, compared.Status);
    ...
    [InlineData("(string) (object) 5", "EVAL_OPERAND_TYPE_UNSUPPORTED")]
    [InlineData("(DayOfWeek) (object) \"abc\"", "EVAL_OPERAND_TYPE_UNSUPPORTED")]
    ...
    public void Downcasts_within_a_hierarchy_keep_the_runtime_value()
    {
        ...
        Assert.Equal(ExpressionEvaluationStatus.Exact, roundTrip.Status);
        ...
        Assert.Equal(ExpressionEvaluationStatus.Invalid, refused.Status);
