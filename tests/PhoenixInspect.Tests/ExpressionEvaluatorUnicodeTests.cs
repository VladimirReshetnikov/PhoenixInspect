...
/// </summary>
public sealed class ExpressionEvaluatorUnicodeTests
{
    ...
    [InlineData("Rune.ToUpper(new Rune('a'), null)", "EVAL_CULTURE_SENSITIVE_UNSUPPORTED")]
    [InlineData("char.ToUpper('a')", "EVAL_CULTURE_SENSITIVE_UNSUPPORTED")]
    [InlineData("char.TryParse(\"x\", null)", "EVAL_MEMBER_UNSUPPORTED")]
