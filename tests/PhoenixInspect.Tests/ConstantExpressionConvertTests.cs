...
/// </summary>
public sealed class ConstantExpressionConvertTests
{
    ...
    [InlineData("Convert.ToDateTime(\"2024-01-01\")", "CONSTANT_CULTURE_SENSITIVE_UNSUPPORTED")]
    [InlineData("Convert.ToInt32(Guid.Empty)", "CONSTANT_OPERAND_TYPE_UNSUPPORTED")]
    [InlineData("Convert.ChangeType(5, typeof(Guid))", "CONSTANT_OPERAND_TYPE_UNSUPPORTED")]
