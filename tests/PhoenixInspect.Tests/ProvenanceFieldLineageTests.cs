...
public sealed class ProvenanceFieldLineageTests
{
    private const string FieldOriginId =
        "382985b46ab23ba7622328679d2d0deefe8cd141eee093bb18a38df603cca154";
    private const string FieldOriginCanonicalHex =
        "0000002550686F656E6978496E73706563742E50726F76656E616E63654C696E656167652E4E" +
        "6F646500000001000000010000000200000002000000030000000700000001CCE4915B1F1C68" +
        "675E0A8F2865112E1C37BA885AA95F177CE7FAF2AD28457D740000001057342E4669656C642E" +
        "5061727469616C";
    private const string FieldTransformId =
        "4febf8d8fbc9f14363aed91a37cbe4e50ba56a79739cc3329ef24f7dcc244f51";
    private const string FieldTransformCanonicalHex =
        "0000002550686F656E6978496E73706563742E50726F76656E616E63654C696E656167652E4E" +
        "6F6465000000010000000300000002000000024A64B622042ECA95E3A5D375898ACD17E445D1" +
        "B2500374DF3892E8D689982209E5B31046F1FF4B2440EDAE7E12F0E3610400000100000003E5" +
        "B31046F1FF4B2440EDAE7E12F0E36102000001000000020000000200000001382985B46AB23B" +
        "A7622328679D2D0DEEFE8CD141EEE093BB18A38DF603CCA154";
    private const string FieldGraphSha256 =
        "053a206ee6e9b102493eb9f24635e41e621e03bac77b6ba0e93f3c099b4d2c6a";

    private const string W42InputOriginId =
        "1243a660bc3df1fc5b8581345183b83389c18e5e47ee59c8af63c88d36350ee9";
    private const string W42BinaryTransformId =
        "2d1e6069e0ad90ad9eb7ab5217d7ffd5e1aedeaf2e85b2aa14c827c757700882";
    ...
    private static readonly TypeSig OwnerType = TypeSig.CreateTypeDefinition(
        Module,
        0x02000001,
        "PhoenixInspect.Tests.W43.Owner");
