...
/// matching budget.
/// </summary>
public sealed class ConstantExpressionTextTests
{
    ...
    [Theory]
    [InlineData("Encoding.UTF8.WebName", ConstantValueKind.String, "utf-8")]
    [InlineData("Encoding.UTF8.CodePage", ConstantValueKind.Int32, "65001")]
    [InlineData("System.Text.Encoding.Unicode.CodePage", ConstantValueKind.Int32, "1200")]
    [InlineData("Encoding.GetEncoding(\"utf-8\").CodePage", ConstantValueKind.Int32, "65001")]
    [InlineData("Encoding.GetEncoding(20127).WebName", ConstantValueKind.String, "us-ascii")]
    [InlineData("Encoding.Latin1.IsSingleByte", ConstantValueKind.Boolean, "True")]
    [InlineData("Encoding.UTF8.GetByteCount(\"héllo\")", ConstantValueKind.Int32, "6")]
    [InlineData("Encoding.Unicode.GetByteCount(\"hi\")", ConstantValueKind.Int32, "4")]
    [InlineData("Encoding.UTF8.GetString(new byte[] { 72, 105 })", ConstantValueKind.String, "Hi")]
    [InlineData(
        "Encoding.Unicode.GetString(Encoding.Convert(Encoding.UTF8, Encoding.Unicode, "
        + "Encoding.UTF8.GetBytes(\"réponse\")))",
        ConstantValueKind.String,
        "réponse")]
    [InlineData("Encoding.UTF8.GetBytes(\"é\").Length", ConstantValueKind.Int32, "2")]
    [InlineData("Encoding.Unicode.GetPreamble().Length", ConstantValueKind.Int32, "2")]
    [InlineData("Encoding.UTF8.GetCharCount(new byte[] { 195, 169 })", ConstantValueKind.Int32, "1")]
    [InlineData("Encoding.ASCII.GetChars(new byte[] { 72 })[0] == 'H'", ConstantValueKind.Boolean, "True")]
    [InlineData("Encoding.UTF8.GetMaxByteCount(10)", ConstantValueKind.Int32, "33")]
    [InlineData("Encoding.UTF8 == Encoding.GetEncoding(65001)", ConstantValueKind.Boolean, "True")]
    [InlineData("Encoding.UTF8 != Encoding.ASCII", ConstantValueKind.Boolean, "True")]
    [InlineData("Encoding.UTF8.Equals(Encoding.GetEncoding(\"utf-8\"))", ConstantValueKind.Boolean, "True")]
    [InlineData("Regex.IsMatch(\"abc123\", \"\\\\d+\")", ConstantValueKind.Boolean, "True")]
    [InlineData("Regex.IsMatch(\"abc\", \"^[0-9]+$\")", ConstantValueKind.Boolean, "False")]
    [InlineData(
        "System.Text.RegularExpressions.Regex.IsMatch(\"x7\", \"[0-9]\")",
        ConstantValueKind.Boolean,
        "True")]
    [InlineData("Regex.Match(\"abc123\", \"[0-9]+\").Value", ConstantValueKind.String, "123")]
    [InlineData("Regex.Match(\"abc123\", \"[0-9]+\").Index", ConstantValueKind.Int32, "3")]
    [InlineData("Regex.Match(\"abc123\", \"[0-9]+\").Length", ConstantValueKind.Int32, "3")]
    [InlineData("Regex.Match(\"abc\", \"z\").Success", ConstantValueKind.Boolean, "False")]
    [InlineData("Regex.Match(\"a1b2\", \"[0-9]\").NextMatch().Value", ConstantValueKind.String, "2")]
    [InlineData(
        "Regex.Match(\"john@example.com\", \"^(\\\\w+)@\").Result(\"$1\")",
        ConstantValueKind.String,
        "john")]
    [InlineData("Regex.Matches(\"a1b22c333\", \"[0-9]+\").Count", ConstantValueKind.Int32, "3")]
    [InlineData("Regex.Matches(\"a1b22c333\", \"[0-9]+\")[2].Value", ConstantValueKind.String, "333")]
    [InlineData(
    ...
    [InlineData(
        ...
        "6")]
    [InlineData("Regex.Replace(\"a1b2\", \"[0-9]\", \"#\")", ConstantValueKind.String, "a#b#")]
    [InlineData("Regex.Count(\"a1b22c\", \"[0-9]\")", ConstantValueKind.Int32, "3")]
    [InlineData("Regex.Escape(\"a.b\")", ConstantValueKind.String, "a\\.b")]
    [InlineData("Regex.Unescape(\"a\\\\.b\")", ConstantValueKind.String, "a.b")]
    [InlineData("new Regex(\"[a-z]+\").IsMatch(\"abc\")", ConstantValueKind.Boolean, "True")]
    [InlineData("new Regex(\"[a-z]+\").ToString()", ConstantValueKind.String, "[a-z]+")]
    [InlineData("new Regex(\"a\").Count(\"banana\")", ConstantValueKind.Int32, "3")]
    [InlineData(
    ...
    [InlineData(
        ...
        ConstantValueKind.Int32,
        "1")]
    [InlineData("new Regex(\"(?<x>a)(b)\").GroupNumberFromName(\"x\")", ConstantValueKind.Int32, "2")]
    [InlineData("new Regex(\"(?<x>a)(b)\").GetGroupNames().Length", ConstantValueKind.Int32, "3")]
    [InlineData(
        "new Regex(\"a\", RegexOptions.Multiline).Options == RegexOptions.Multiline",
        ConstantValueKind.Boolean,
        "True")]
    public void Text_values_fold_exactly(string expression, ConstantValueKind expectedKind, string expected)
    {
    ...
    [InlineData("Encoding.UTF7", "CONSTANT_MEMBER_UNSUPPORTED")]
    [InlineData("Encoding.UTF8.GetString(new[] { 72, 105 })", "CONSTANT_OPERAND_TYPE_UNSUPPORTED")]
    [InlineData("Encoding.UTF8 + Encoding.ASCII", "CONSTANT_OPERAND_TYPE_UNSUPPORTED")]
    [InlineData("Encoding.UTF8 < Encoding.ASCII", "CONSTANT_OPERAND_TYPE_UNSUPPORTED")]
    [InlineData("new Regex(\"a\") == new Regex(\"a\")", "CONSTANT_OPERAND_TYPE_UNSUPPORTED")]
    ...
    public void Catastrophic_backtracking_stops_with_the_budget_named()
    {
        ...
        Assert.Equal(ConstantExpressionStatus.Exact, linear.Status);
