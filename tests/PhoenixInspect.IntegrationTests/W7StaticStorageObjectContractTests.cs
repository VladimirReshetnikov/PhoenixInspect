...
public sealed class W7StaticStorageObjectContractTests
{
    ...
    public void Physical_contract_surface_is_detached_and_contains_no_legacy_semantic_graph()
    {
        ...
        Assert.Null(assembly.GetType("PhoenixInspect.Host.Dump.ClrMD.ClrmdStaticFieldDeclaration"));
        Assert.Null(assembly.GetType("PhoenixInspect.Host.Dump.ClrMD.ClrmdStaticDeclaredTargetIdentity"));
        Assert.Null(assembly.GetType("PhoenixInspect.Host.Dump.ClrMD.ClrmdStaticTypeAncestryIdentity"));
    }
