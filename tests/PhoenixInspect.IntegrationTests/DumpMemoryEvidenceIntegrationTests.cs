...
public sealed partial class DumpMemoryEvidenceIntegrationTests
{
    ...
    public void Full_dump_recovers_rooted_values_with_counted_memory_evidence()
    {
        ...
        try
        {
            ...
            var module = Assert.Single(session.FindModulesByFileName("PhoenixInspect.TestTarget.dll"));
            ...
            Assert.EndsWith("PhoenixInspect.TestTarget.dll", module.TargetPathHint, StringComparison.OrdinalIgnoreCase);
            ...
            Assert.Equal(
                module.Identity,
                Assert.Single(session.FindModulesByFileName("PhoenixInspect.TestTarget.dll")).Identity);
            ...
            var replayModule = Assert.Single(replaySession.FindModulesByFileName("PhoenixInspect.TestTarget.dll"));
