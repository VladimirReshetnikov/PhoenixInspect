...
{
    internal const string AssemblyFileName = "PhoenixInspect.W7TestTarget.dll";
    ...
    internal static string ResolveExecutable()
    {
        ...
        var executableName = RuntimeInformation.IsOSPlatform(OSPlatform.Windows)
            ? "PhoenixInspect.W7TestTarget.exe"
            : "PhoenixInspect.W7TestTarget";
        return Path.Combine(
            testsRoot,
            "PhoenixInspect.W7TestTarget",
            "bin",
    ...
    internal static string ResolvePortablePdb()
    {
        ...
        return Path.Combine(directory, "PhoenixInspect.W7TestTarget.pdb");
    }
}
...
public sealed class W7ExpressionContextProducerIntegrationTests
{
    ...
    [InlineData(
        ...
        "PhoenixInspect.W7TestTarget.Workflow",
