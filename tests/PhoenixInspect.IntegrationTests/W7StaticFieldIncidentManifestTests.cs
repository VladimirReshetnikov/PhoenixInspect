...
public sealed class W7StaticFieldIncidentManifestTests
{
    ...
    public void Manifest_freezes_sixteen_independent_meaningful_incidents()
    {
        ...
        Assert.Equal(
            "tests/PhoenixInspect.W7TestTarget/PhoenixInspect.W7TestTarget.csproj",
        ...
        Assert.Equal(
            new[]
            {
                "tests/PhoenixInspect.W7TestTarget/Program.cs",
                "tests/PhoenixInspect.W7TestTarget/StaticValues.cs",
                "tests/PhoenixInspect.W7TestTarget/RequestPipeline.cs",
                "tests/PhoenixInspect.W7TestTarget/BatchPipeline.cs",
                "tests/PhoenixInspect.W7TestTarget/CoordinatorPipeline.cs",
                "tests/PhoenixInspect.W7TestTarget/WorkflowPipeline.cs",
            },
        ...
        Assert.Equal(
            "global::PhoenixInspect.W7TestTarget.StaticValues.Counter",
    ...
    private static string ResolveManifestPath()
    {
        ...
        while (current is not null && !File.Exists(Path.Combine(current.FullName, "PhoenixInspect.sln")))
        {
