...
public sealed class W8V2SyntaxProjectionTests
{
    private const string GenericSlotExpression =
        "global::PhoenixInspect.W8TestTarget.GenericSlot<global::PhoenixInspect.W8TestTarget.RequestContext>.Current";
    ...
    private const string GoldenGenericSlotDescriptorSha256 =
        "82c0accff94d988a61beaf59da2e08053c41dd4346f8b3cd4bb33b60909813a6";
    ...
    public void Global_alias_generic_owner_is_admitted_with_complete_partition_universe()
    {
        ...
        Assert.Equal(
            new[] { "PhoenixInspect", "W8TestTarget", "GenericSlot", "Current" },
        ...
        Assert.Equal(
            new[] { "PhoenixInspect", "W8TestTarget", "RequestContext" },
