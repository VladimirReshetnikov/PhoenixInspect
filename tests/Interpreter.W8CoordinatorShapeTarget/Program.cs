...
using static Interpreter.W8CoordinatorShapeTarget.CoordinatorTotals;
using RegionsNs = Interpreter.W8CoordinatorShapeTarget.Values;

namespace Interpreter.W8CoordinatorShapeTarget;
