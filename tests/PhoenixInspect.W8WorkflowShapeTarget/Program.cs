...
public static class WorkflowShapeGate
{
    ...
    public static int Run(string profile)
    {
        ...
        wflib::PhoenixInspect.W8AliasTarget.IExternalInterfaceSlot<
            wflib::PhoenixInspect.W8AliasTarget.ExternalRequestContext>.Sentinel = 0x41_00_04_08;
        wflib::PhoenixInspect.W8AliasTarget.ExternalSlot<
        ...
        return profile switch
        {
            ...
            "workflow-extern-alias-interface" => WorkflowPause.WaitForDump(
                profile,
                wflib::PhoenixInspect.W8AliasTarget.IExternalInterfaceSlot<
                    wflib::PhoenixInspect.W8AliasTarget.ExternalRequestContext>.Sentinel),
    ...
    private static void MaterializeSecondDefinition()
    {
        ...
        var duplicated = loadedAssembly.GetType(
            "PhoenixInspect.W8WorkflowShapeTarget.DuplicatedStageStatics",
            throwOnError: true,
            ignoreCase: false)!;
