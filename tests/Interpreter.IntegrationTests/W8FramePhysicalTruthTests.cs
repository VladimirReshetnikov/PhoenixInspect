...
internal sealed class W8FrameMetadataCatalog
{
    ...
    internal static W8FrameMetadataCatalog Read(string assemblyPath, string pdbPath)
    {
        ...
        var requestContext = FindType(reader, "Interpreter.W8TestTarget", "RequestContext");
        var batchContext = FindType(reader, "Interpreter.W8TestTarget", "BatchContext");
        var definitions = new[]
        {
            CreateProfile(
                peReader,
            ...
            CreateProfile(
                ...
                reader,
                "lexical-frame",
                "Interpreter.W8TestTarget.LexicalEvidence",
                "LexicalCatalogProbe",
                "Run",
                parameterCount: 3,
                declaringTypeGenericArity: 0,
