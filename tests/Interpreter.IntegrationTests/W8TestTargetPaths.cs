...
{
    internal const string AssemblyFileName = "Interpreter.W8TestTarget.dll";
    internal const string AliasAssemblyFileName = "Interpreter.W8AliasTarget.dll";
    internal const string ForwarderAssemblyFileName = "Interpreter.W8ForwarderTarget.dll";
    internal const string NamedRvaAssemblyFileName = "Interpreter.W8NamedRvaTarget.dll";
    internal const string PortablePdbFileName = "Interpreter.W8TestTarget.pdb";

    internal static string ResolveExecutable()
    {
        var executableName = RuntimeInformation.IsOSPlatform(OSPlatform.Windows)
            ? "Interpreter.W8TestTarget.exe"
            : "Interpreter.W8TestTarget";
