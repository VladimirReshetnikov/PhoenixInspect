...
public sealed class W8CompilerPhysicalTruthTests
{
    ...
    private const string AliasNamespace = "Interpreter.W8AliasTarget";
    private const string AliasAssemblyName = "Interpreter.W8AliasTarget";
    ...
    public void CodeView_and_portable_pdb_headers_have_one_exact_physical_identity()
    {
        ...
        Assert.Equal(
            "/_/tests/Interpreter.W8TestTarget/obj/Release/net10.0/Interpreter.W8TestTarget.pdb",
    ...
    public void Primitive_literals_and_rva_payload_have_exact_metadata_encodings()
    {
        ...
        var literalExpectations = new[]
        {
            ...
            new LiteralExpectation(
                "Interpreter.Tests.Infrastructure.HeadlessTestProcess::SuppressedErrorModeMask",
                ConstantTypeCode.UInt32,
                LittleEndian(0x00008003U)),
            new LiteralExpectation(
                "Interpreter.Tests.Infrastructure.HeadlessTestProcess::WerAlwaysShowUi",
                ConstantTypeCode.UInt32,
                LittleEndian(0x00000010U)),
            new LiteralExpectation(
                "Interpreter.Tests.Infrastructure.HeadlessTestProcess::WerNoUi",
                ConstantTypeCode.UInt32,
    ...
    public void Named_rva_fixture_has_exact_rows_payloads_and_pe_geometry()
    {
        ...
        var owner = reader.GetTypeDefinition(
            FindTopLevelType(reader, "Interpreter.W8NamedRvaTarget", "NamedRvaStorage"));
    ...
    public void Alias_and_forwarder_rows_converge_on_complete_assembly_identities()
    {
        ...
        var forwarderReferenceHandle = FindAssemblyReference(reader, "Interpreter.W8ForwarderTarget");
    ...
    public void Roslyn_semantics_distinguish_forwarder_convergence_from_same_level_ambiguity()
    {
        ...
        const string convergenceSource = """
            using Interpreter.W8AliasTarget;
        ...
        const string ambiguitySource = """
            using Interpreter.W8AliasTarget;
            using Interpreter.W8TestTarget;
        ...
        Assert.Equal(
            new[] { AliasAssemblyName, "Interpreter.W8TestTarget" },
    ...
    public void Accessibility_flags_and_owner_visibility_form_complete_physical_matrices()
    {
        ...
        Assert.Equal("Interpreter.W8TestTarget", friendValue);
        Assert.DoesNotContain(
    ...
    public void Each_declared_pause_method_has_exact_active_and_inactive_lexical_evidence()
    {
        ...
        var frames = new[]
        {
            ...
            Frame(
                ...
                [("retainedName", "string")]),
            Frame(
                "ambiguity-frame", "Interpreter.W8AmbiguityEvidence", "CrossAssemblyAmbiguityProfile", "Run", 61,
                [], [], [("profile", "string")],
    ...
    public void Portable_pdb_imports_shadowing_and_locals_are_exact()
    {
        ...
        Assert.Equal(
            new[]
            {
                ...
                "9|NamedRvaStorage|Interpreter.W8NamedRvaTarget.NamedRvaStorage",
        ...
        Assert.Equal(new[] { "6|requestlib|Interpreter.W8AliasTarget" },
        ...
        var ambiguityRun = FindMethod(
            reader,
            "Interpreter.W8AmbiguityEvidence",
        ...
        Assert.Equal(
            new[] { "1|Interpreter.W8AliasTarget", "1|Interpreter.W8TestTarget" },
    ...
    public void Independent_copied_fact_perturbations_do_not_change_unrelated_evidence()
    {
        ...
        var namedOwner = named.Reader.GetTypeDefinition(
            FindTopLevelType(named.Reader, "Interpreter.W8NamedRvaTarget", "NamedRvaStorage"));
