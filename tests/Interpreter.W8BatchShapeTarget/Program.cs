...
using BatchLedgerAlias = Interpreter.W8BatchShapeTarget.Ledger<Interpreter.W8BatchShapeTarget.BatchKey>;
...
public static class BatchShapeGate
{
    ...
    public static int Run(string profile)
    {
        ...
        Interpreter.W8AliasTarget.ExternalSlot<Interpreter.W8AliasTarget.ForwardedRequestContext>.Sentinel =
            0x61_00_02_09;
        Interpreter.W8AliasTarget.ExternalSlot<Interpreter.W8AliasTarget.ForwardedRequestContext>.Current =
            new Interpreter.W8AliasTarget.ForwardedRequestContext("batch-forwarded-227");
