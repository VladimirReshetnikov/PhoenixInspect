...
using ConstructedAlias = PhoenixInspect.W8TestTarget.GenericSlot<PhoenixInspect.W8TestTarget.RequestContext>;
using ExternalInterfaceAlias = requestlib::PhoenixInspect.W8AliasTarget.IExternalInterfaceSlot<requestlib::PhoenixInspect.W8AliasTarget.ExternalRequestContext>;
using MatrixAlias = PhoenixInspect.W8TestTarget.RequestContext[,];
using NestedOwnerAlias = PhoenixInspect.W8TestTarget.Outer<PhoenixInspect.W8TestTarget.RequestContext>.Middle.Inner<PhoenixInspect.W8TestTarget.BatchContext>;
using TypeDefinitionAlias = PhoenixInspect.W8TestTarget.RequestContext;
using TypeReferenceAlias = requestlib::PhoenixInspect.W8AliasTarget.ExternalRequestContext;
using VectorAlias = PhoenixInspect.W8TestTarget.RequestContext[];
using System.Runtime.CompilerServices;
using static PhoenixInspect.W8TestTarget.NonGenericImports;
using static PhoenixInspect.W8TestTarget.StaticImports<PhoenixInspect.W8TestTarget.BatchContext>;
