...
- **W6 delivery status:** the detailed W6 and
  ...
  semantics, evidence, and bounds before any value read. W6.5 now solely owns derived-query evaluation, facade
  routing, and generated headless conformance. W6's umbrella scale is `~10K LOC` split into `~1K LOC` evidence
  checkpoints.
