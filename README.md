...
- **W6 delivery status:** the detailed W6 and
  ...
  terminal value. W6.4 now owns counted reference observation, non-root target identity, and the complete immutable
  member-chain plan. W6's umbrella scale is `~10K LOC` split into `~1K LOC` evidence checkpoints.
