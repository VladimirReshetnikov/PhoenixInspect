...
- **W6 delivery status:** the detailed W6 and
  ...
  schema v1 remains unchanged. W6.6's twenty-four-incident/four-shape portfolio and next-decision gate are now the sole
  active checkpoint. W6's umbrella scale is `~10K LOC` split into `~1K LOC` evidence checkpoints.
